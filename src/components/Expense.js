...
export default function Expense(){
    ...
    async function SubtractFromTheWallet(uid, expense) {
        try {
            ...
            querySnapshot.forEach(async (doc) => {
                ...
                const newAmount = amountInWallet - expenseAmount;
            ...
            return isLess; // Return isLess to indicate if subtraction was successful
        } catch (error) {
    ...
    async function AddExpenditure(uid,walletName){
        try {
            ...
            let isLess = await SubtractFromTheWallet(uid,expense);
            if(!isLess){
                setShowLoader(true);
            ...
            <div className='description--div'>
                <div className="amount--description--div">
                    ...
                    <div className="descrip--div">
                        ...
                        <input style={{borderColor : showDescriptionWarn ? "#b01018" : 'grey'}} type='text' value={expense.description} placeholder='Bought a new Iphone' className='amt--input' minLength="1" maxLength={50} onChange={handleDescriptionChange}></input>
                    </div>
